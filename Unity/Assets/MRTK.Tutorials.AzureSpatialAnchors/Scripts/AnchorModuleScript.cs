...
public class AnchorModuleScript : MonoBehaviour
{
    ...
    public EventHandler AzureSessionStarted;
    public EventHandler AnchorLocated;
    public EventHandler AzureSessionStartFailed;
    ...
    private void Awake()
    {
        ...
        cloudManager.AnchorLocated += AnchorLocated.Invoke;
    ...
    public async void StartAzureSession()
    {
        ...
        try
        {
            ...
            AzureSessionStarted?.Invoke(this, EventArgs.Empty);
            //Debug.Log("Azure session started successfully");
        }
        catch (Exception e)
        {
            AzureSessionStartFailed?.Invoke(this, EventArgs.Empty);
        }
    }
...
//    }
    ...
    private void CloudManager_AnchorLocated(object sender, AnchorLocatedEventArgs args)
    {
        ...
        if (args.Status == LocateAnchorStatus.Located || args.Status == LocateAnchorStatus.AlreadyTracked)
        {
            ...
            QueueOnUpdate(() =>
            {
                ...
                {
                    gameObject.ApplyCloudAnchor(currentCloudAnchor);
    ...
    private IEnumerator GetSharedAzureAnchorIDCoroutine(string sharingPin)
    {
    ...
    #endregion Internal Methods and Coroutines
